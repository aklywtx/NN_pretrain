...
for m in tqdm(range(0, 101), desc="Percentage black"):
    for N in tqdm([100], desc=f"Num dots (m={m})", leave=False):
        for i in range(5):
            ...
            plt.savefig(f"./test_data/displays_dpi32_MLPtest_only100dots/image_{num_black_dots}_{N}_{i}.png", 
                    dpi=32,
                    bbox_inches='tight',
                    pad_inches=0) 
...
#         # Save the plot to a file
#         plt.savefig(f"./displays_dpi64/image_{num_black_dots}_{N}_{i}.png", 
#                 dpi=32,
#                 bbox_inches='tight',
#                 pad_inches=0,
#                 cmap='gray') 
